...
public class QwertzLayoutCZLinux implements Layout {
    private TreeMap<Character, KeyCode> keyTable;

    protected QwertzLayoutCZLinux() {
        ...
        keyMap.put((char) 0x04, new char[]{'a', 'A', '~'});    // Keyboard a and A
        keyMap.put((char) 0x05, new char[]{'b', 'B', '{'});    // Keyboard b and B
        keyMap.put((char) 0x06, new char[]{'c', 'C', '&'});    // Keyboard c and C
        keyMap.put((char) 0x07, new char[]{'d', 'D', 'Đ'});    // Keyboard d and D
        keyMap.put((char) 0x08, new char[]{'e', 'E', '€'});    // Keyboard e and E
        keyMap.put((char) 0x09, new char[]{'f', 'F', '['});    // Keyboard f and F
        keyMap.put((char) 0x0A, new char[]{'g', 'G', ']'});    // Keyboard g and G
        keyMap.put((char) 0x0B, new char[]{'h', 'H', '`'});    // Keyboard h and H
        keyMap.put((char) 0x0C, new char[]{'i', 'I', '→'});    // Keyboard i and I
        keyMap.put((char) 0x0D, new char[]{'j', 'J', '\''});    // Keyboard j and J
        keyMap.put((char) 0x0E, new char[]{'k', 'K', 'ł'});    // Keyboard k and K
        keyMap.put((char) 0x0F, new char[]{'l', 'L', 'Ł'});    // Keyboard l and L
        keyMap.put((char) 0x10, new char[]{'m', 'M', '^'});    // Keyboard m and M
        keyMap.put((char) 0x11, new char[]{'n', 'N', '}'});    // Keyboard n and N
        keyMap.put((char) 0x12, new char[]{'o', 'O', 'ø'});    // Keyboard o and O
        keyMap.put((char) 0x13, new char[]{'p', 'P', 'þ'});    // Keyboard p and P
        keyMap.put((char) 0x14, new char[]{'q', 'Q', '\\'});    // Keyboard q and Q
        keyMap.put((char) 0x15, new char[]{'r', 'R', '¶'});    // Keyboard r and R
        keyMap.put((char) 0x16, new char[]{'s', 'S', 'đ'});    // Keyboard s and S
        keyMap.put((char) 0x17, new char[]{'t', 'T', 'ŧ'});    // Keyboard t and T
        keyMap.put((char) 0x18, new char[]{'u', 'U', '↓'});    // Keyboard u and U
        keyMap.put((char) 0x19, new char[]{'v', 'V', '@'});    // Keyboard v and V
        keyMap.put((char) 0x1A, new char[]{'w', 'W', '|'});    // Keyboard w and W
        keyMap.put((char) 0x1B, new char[]{'x', 'X', '#'});    // Keyboard x and X
        keyMap.put((char) 0x1C, new char[]{'z', 'Z', '←'});    // Keyboard y and Y
        keyMap.put((char) 0x1D, new char[]{'y', 'Y', '°'});    // Keyboard z and Z
        keyMap.put((char) 0x1E, new char[]{'+', '1', '!'});    // Keyboard 1 and !
        keyMap.put((char) 0x1F, new char[]{'ě', '2', '@'});    // Keyboard 2 and "
        keyMap.put((char) 0x20, new char[]{'š', '3', '#'});    // Keyboard 3 and #
        keyMap.put((char) 0x21, new char[]{'č', '4', '$'});    // Keyboard 4 and $
        keyMap.put((char) 0x22, new char[]{'ř', '5', '%'});    // Keyboard 5 and %
        keyMap.put((char) 0x23, new char[]{'ž', '6', '^'});    // Keyboard 6 and ^
        keyMap.put((char) 0x24, new char[]{'ý', '7', '&'});    // Keyboard 7 and &
        keyMap.put((char) 0x25, new char[]{'á', '8', '*'});    // Keyboard 8 and *
        keyMap.put((char) 0x26, new char[]{'í', '9', '{'});    // Keyboard 9 and (
        keyMap.put((char) 0x27, new char[]{'é', '0', '}'});    // Keyboard 0 and )
        ...
        keyMap.put((char) 0x2D, new char[]{'=', '%', '\\'});    // Keyboard - and (underscore)
        keyMap.put((char) 0x2E, new char[]{'\u0301', '\u030C', '\u0304'});    // Keyboard = and + // acute, caron, macron
        keyMap.put((char) 0x2F, new char[]{'ú', '/', '['});    // Keyboard [ and {
        keyMap.put((char) 0x30, new char[]{')', '(', ']'});    // Keyboard ] and }
        keyMap.put((char) 0x31, new char[]{'\u0308', '\'', '\\'});    // Keyboard \ and | // diaeresis/umlaut
        keyMap.put((char) 0x32, new char[]{'\0', '\0', '\0'});    // Keyboard Non-US # and ~
        keyMap.put((char) 0x33, new char[]{'ů', '"', '$'});    // Keyboard ; and :
        keyMap.put((char) 0x34, new char[]{'§', '!', '\''});    // Keyboard ‘ and “
        keyMap.put((char) 0x35, new char[]{';', '\u030A', '`'});    // Keyboard Grave Accent and Tilde // ring-above
        keyMap.put((char) 0x36, new char[]{',', '?', '<'});    // Keyboard , and <
        keyMap.put((char) 0x37, new char[]{'.', ':', '>'});    // Keyboard . and >
        keyMap.put((char) 0x38, new char[]{'-', '_', '*'});    // Keyboard / and ?
        ...
        keyMap.put((char) 0x64, new char[]{'\\', '|', '/'});    // Keyboard Non-US \ and |
