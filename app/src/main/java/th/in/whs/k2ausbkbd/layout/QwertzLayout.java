...
public class QwertzLayout implements Layout {
    ...
    protected QwertzLayout() {
        ...
        keyMap.put((char)0x10, new char[]{'m', 'M', 'µ'}); 	// Keyboard m and M
        ...
        keyMap.put((char)0x1C, new char[]{'z', 'Z', '\0'}); 	// Keyboard y and Y
        keyMap.put((char)0x1D, new char[]{'y', 'Y', '\0'}); 	// Keyboard z and Z
        keyMap.put((char)0x1E, new char[]{'1', '!', '\0'}); 	// Keyboard 1 and !
        keyMap.put((char)0x1F, new char[]{'2', '"', '²'}); 	// Keyboard 2 and "
        keyMap.put((char)0x20, new char[]{'3', '§', '³'}); 	// Keyboard 3 and #
        ...
        keyMap.put((char)0x24, new char[]{'7', '/', '{'}); 	// Keyboard 7 and &
        keyMap.put((char)0x25, new char[]{'8', '(', '['}); 	// Keyboard 8 and *
        keyMap.put((char)0x26, new char[]{'9', ')', ']'}); 	// Keyboard 9 and (
        keyMap.put((char)0x27, new char[]{'0', '=', '}'}); 	// Keyboard 0 and )
        ...
        keyMap.put((char)0x2D, new char[]{'ß', '?', '\\'}); 	// Keyboard - and (underscore)
        keyMap.put((char)0x2E, new char[]{'´', '`', '\0'}); 	// Keyboard = and +
        keyMap.put((char)0x2F, new char[]{'ü', 'Ü', '\0'}); 	// Keyboard [ and {
        ...
        keyMap.put((char)0x33, new char[]{'ö', 'Ö', '\0'}); 	// Keyboard ; and :
        keyMap.put((char)0x34, new char[]{'ä', 'Ä', '\0'}); 	// Keyboard ‘ and “
        ...
        keyMap.put((char)0x38, new char[]{'-', '_', '\0'}); 	// Keyboard / and ?
