...
public class AzertyLayout implements Layout {
    ...
    protected AzertyLayout() {
        ...
        keyMap.put((char)0x04, new char[]{'q', 'Q', '\0'}); 	// Keyboard a and A
        ...
        keyMap.put((char)0x10, new char[]{',', ':', '\0'}); 	// Keyboard m and M
        ...
        keyMap.put((char)0x14, new char[]{'a', 'A', '\0'}); 	// Keyboard q and Q
        ...
        keyMap.put((char)0x1A, new char[]{'z', 'Z', '\0'}); 	// Keyboard w and W
        keyMap.put((char)0x1B, new char[]{'x', 'X', '\0'}); 	// Keyboard x and X
        keyMap.put((char)0x1C, new char[]{'y', 'Y', '\0'}); 	// Keyboard y and Y
        keyMap.put((char)0x1D, new char[]{'w', 'W', '\0'}); 	// Keyboard z and Z
        keyMap.put((char)0x1E, new char[]{'&', '1', '\0'}); 	// Keyboard 1 and !
        keyMap.put((char)0x1F, new char[]{'é', '2', '\0'}); 	// Keyboard 2 and @
        ...
        keyMap.put((char)0x24, new char[]{'è', '7', '\0'}); 	// Keyboard 7 and &
        keyMap.put((char)0x25, new char[]{'_', '8', '\0'}); 	// Keyboard 8 and *
        keyMap.put((char)0x26, new char[]{'ç', '9', '\0'}); 	// Keyboard 9 and (
        keyMap.put((char)0x27, new char[]{'à', '0', '\0'}); 	// Keyboard 0 and )
        ...
        keyMap.put((char)0x2D, new char[]{')', '°', '\0'}); 	// Keyboard - and (underscore)
        ...
        keyMap.put((char)0x31, new char[]{'*', 'µ', '\0'}); 	// Keyboard \ and |
        keyMap.put((char)0x32, new char[]{'\0', '\0', '\0'}); 	// Keyboard Non-US # and ~
        keyMap.put((char)0x33, new char[]{'m', 'M', '\0'}); 	// Keyboard ; and :
        keyMap.put((char)0x34, new char[]{'ù', '%', '\0'}); 	// Keyboard ‘ and “
